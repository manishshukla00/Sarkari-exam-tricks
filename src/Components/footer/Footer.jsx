      ...
      <div className="mx-auto p-5 flex justify-around">
        ...
        <div className="flex flex-col">
          ...
          <ul className="space-y-2">
            <li>
              <a href="#">Sarkari Exam Tricks @X</a>
            </li>
            <li>
              <a href="#">Sarkari Exam Tricks @Telegram</a>
            </li>
            <li>
              <a href="#">Sarkari Exam Tricks @WhatsApp</a>
            </li>
            <li>
              <a href="#">Sarkari Exam Tricks @Instagram</a>
            </li>
            <li>
              <a href="#">Sarkari Exam Tricks @Threads</a>
            </li>
            <li>
              <a href="#">Sarkari Exam Tricks @Facebook</a>
            </li>
            <li>
              <a href="#">Sarkari Exam Tricks @Linkedin</a>
            </li>
            <li>
              <a href="#">Sarkari Exam Tricks @Youtube</a>
            </li>
            <li>
              <a href="#">All Board Exams</a>
            </li>
            <li>
              <a href="#">Sarkari Exam Tricks Contact Us</a>
            </li>
            <li>
